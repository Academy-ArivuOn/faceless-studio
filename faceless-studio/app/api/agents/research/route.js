// app/api/agents/research/route.js
...
export async function POST(request) {
  ...
  try {
    ...
    // ── 5. Build Prompt with Trend Data ──────────────────────────────────────
    const prompt = buildResearchPrompt({
      ...cleanInput,
      trendData, // INJECT TREND DATA
    });
    ...
    if (validation.warningCount > 0) {
      console.warn(
        `[research] ${validation.warningCount} warnings:`,
