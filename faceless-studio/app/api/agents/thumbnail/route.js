...
import { verifyAuth, checkUsage, incrementUsage } from '@/packages/supabase';
import { conceptToDesignSpec, extractDesignElements, determineEditScope } from '@/packages/thumbnail/intelligence';
import { buildImagePrompt, buildVariationPrompts } from '@/packages/thumbnail/prompt-builder';
import { generateThumbnailWithFallback, calculateCTRScore } from '@/packages/thumbnail/image-service';
import { uploadThumbnail, saveThumbnailRecord } from '@/packages/thumbnail/storage';
